  ...
  return (
    <View style={styles.locationsContainer}>
      <ScrollView style={styles.drawerContainer}>
        <DataTable>
          <DataTable.Header>
            <DataTable.Title>Nimetus</DataTable.Title>
            <DataTable.Title numeric>Masinate arv</DataTable.Title>
          </DataTable.Header>
            ...
            <>
              ...
              {isInOpen(item.id) &&
                item.floors?.map((floor) => (
                  <View>
                    <Text>Korrus : {floor.floorNr}</Text>
